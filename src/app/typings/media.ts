...
export class MediaObject {
  ...
  /**
   * An obserable that notifies you when the duration changes
   */
  onDurationUpdate: Observable<number>;
   ...
   * @hidden
   */
  @InstanceProperty durationUpdateCallback: Function;

  /**
   * @hidden
   */
  @InstanceProperty positionUpdateCallback: Function;
  ...
  constructor(private _objectInstance: any) {
    ...
    this.onDurationUpdate = new Observable<number>(
      (observer: Observer<number>) => {
        this.durationUpdateCallback = observer.next.bind(observer);
        return () => (this.durationUpdateCallback = () => { });
      }
    );
  }
